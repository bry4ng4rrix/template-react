...
const Register = () => {
  ...
  const [powner_password,setOwner_password] = useState("")
  const [showPassword, setShowPassword] = useState(false);

  const handleregister = async (e) => {
    e.preventDefault();
    setErreur("mety be ka");
  };
  return (
          ...
          <form className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="grid gap-2">
              ...
              <input
                id="name"
                type="text"
                defaultValue="Brasserie du Port"
            ...
            <div className="grid  gap-2">
              ...
              <input
                id="address"
                type="text"
                defaultValue="123 Rue du Port, 33120 Arcachon"
            ...
            <div className="grid gap-2">
              ...
              <input
                id="owner_email"
                type="email"
                defaultValue="marie@brasserie-port.fr"
